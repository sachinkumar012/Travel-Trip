...
urlpatterns = [
    ...
    path('viewflight/<int:booking_id>',views.ViewFlightDetails,name='ViewFlightDetails'),
    path('viewhotel/<int:booking_id>',views.ViewHotelDetails,name='ViewHotelDetails'),
    path('viewpackage/<int:booking_id>',views.ViewPackageDetails,name='ViewPackageDetails'),
    path('managepassengers/<str:booking_type>/<int:booking_id>',views.ManagePassengers,name='ManagePassengers'),
    ]
